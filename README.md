...
| `+` | `+` |
| [ubuntu-iso-builder-remix-jwm](https://samwhelp.github.io/ubuntu-iso-builder-remix-jwm/) | [GitHub](https://github.com/samwhelp/ubuntu-iso-builder-remix-jwm) |
| `=` | `=` |
| [ubuntu-iso-builder-respin-jwm](https://samwhelp.github.io/ubuntu-iso-builder-respin-jwm/) | [GitHub](https://github.com/samwhelp/ubuntu-iso-builder-respin-jwm) |
...
| Config |
| ------ |
| [~/.config](https://github.com/samwhelp/ubuntu-iso-builder-remix-jwm/tree/main/profile/template/asset/overlay/etc/skel/.config) |
| [/usr/share/glib-2.0/schemas](https://github.com/samwhelp/ubuntu-iso-builder-remix-jwm/tree/main/profile/template/asset/overlay/usr/share/glib-2.0/schemas) |
| [/etc/dconf/db/distro.d](https://github.com/samwhelp/ubuntu-iso-builder-remix-jwm/tree/main/profile/template/asset/overlay/etc/dconf/db/distro.d) |
...
> clone [ubuntu-iso-builder-remix-jwm](https://github.com/samwhelp/ubuntu-iso-builder-remix-jwm)

``` sh
git clone https://github.com/samwhelp/ubuntu-iso-builder-remix-jwm.git
```


> change dir to `ubuntu-iso-builder-remix-jwm`

``` sh
cd ubuntu-iso-builder-remix-jwm
```
...
> change dir to `~/work/ubuntu-iso-builder-remix-jwm/iso-profile`

``` sh
cd ~/work/ubuntu-iso-builder-remix-jwm/iso-profile
```
...
> The resulting ISO file will be placed on `~/work/ubuntu-iso-builder-remix-jwm/iso-profile/dist`
